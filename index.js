...
import messageRouter from './routes/examReg.js'
import boardingRouter from './routes/bording.js'
import admissionRouter from './routes/admission.js'
import medicalRouter from './routes/medicalForm.js'
import suppliesRouter from './routes/storeSupplies.js'
import issuesRouter from './routes/storeIssues.js'
import borrowRouter from './routes/borrowbook.js'
...
app.use('/boadingfinanace', vacation)
app.use('/complain', complain)
app.use('/stats', users)
app.use('/stats', analysis)
app.use('/stats', mile)
app.use('/stats', match)
app.use('/financeclinic', expenses)
app.use('/stats', complainMatch)
app.use('/tenant', tenantRouter)
app.use('/booksin', noticeRouter)
app.use('/caretakervacation', vacationRouter)
app.use('/staff', complainRouter)
...
app.use('/examreg', messageRouter)
app.use('/admission', admissionRouter)
app.use('/boarding', boardingRouter)
app.use('/medical', medicalRouter)
app.use('/issues', suppliesRouter)
app.use('/supplies', issuesRouter)
app.use('/borrowbook', borrowRouter)

app.get('/', (req, res) => res.send('Hello World SMS!'));
